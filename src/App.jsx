      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        >
          <div className="w-40 h-40 md:w-56 md:h-56 mb-6 rounded-[2.5rem] overflow-hidden shadow-md border-4 border-white bg-white">
            <img src={`${import.meta.env.BASE_URL}teacher_icon.jpg`} alt="선생님 메뉴" className="w-full h-full object-cover" />
          </div>
        ...
        >
          <div className="w-40 h-40 md:w-56 md:h-56 mb-6 rounded-[2.5rem] overflow-hidden shadow-md border-4 border-white bg-white">
            <img src={`${import.meta.env.BASE_URL}student_icon.jpg`} alt="우리반 급식 보기" className="w-full h-full object-cover" />
          </div>
...
function App() {
  return (
    <BrowserRouter basename="/School_lunch_menu">
      <Routes>
