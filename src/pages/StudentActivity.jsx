    ...
    <div className="flex-1 flex flex-col items-center justify-center w-full min-h-full space-y-8 py-4">
      ...
      <div className="w-full max-w-5xl aspect-video rounded-3xl overflow-hidden shadow-2xl border-[12px] border-pastel-yellow">
        <iframe 
          width="100%" 
          height="100%" 
          src="https://www.youtube.com/embed/GOOtLgg9GyY?autoplay=0" 
          title="요일송" 
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center w-full min-h-full space-y-3 md:space-y-4 py-4">
      ...
      <button 
        ...
        className="w-full max-w-5xl bg-white border-4 border-gray-600 shadow-2xl flex flex-col transform hover:scale-[1.01] transition-transform font-bold flex-1 min-h-0"
      >
        {/* 상단 (연도, 월) */}
...
function Activity3() {
  ...
  const weathers = [
    { id: 'sunny', image: '/images/weather_sunny.jpg', name: '맑음' },
    { id: 'cloudy', image: '/images/weather_cloudy.jpg', name: '흐림' },
    { id: 'rainy', image: '/images/weather_rainy.jpg', name: '비' },
    { id: 'snowy', image: '/images/weather_snowy.jpg', name: '눈' },
  ]
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center w-full min-h-full space-y-4 py-4">
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex flex-col gap-6 w-full max-w-[1500px] flex-1 min-h-0 items-center justify-center">
              ...
              {item ? (
                ...
                <>
                  {targetItem && targetItem.imageUrl && (
                    <img src={targetItem.imageUrl} className="absolute inset-0 w-full h-full object-cover opacity-[0.15] grayscale pointer-events-none" />
                  )}
                  <span className="text-gray-500 font-bold text-xl md:text-2xl pointer-events-none z-10 bg-white/70 px-4 py-2 rounded-2xl backdrop-blur-sm shadow-sm">{label}</span>
                </>
              )}
